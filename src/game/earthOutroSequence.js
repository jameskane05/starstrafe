...
const OVERLAY_ID = "earth-outro-overlay";

const LINE1 = "Though ravaged by the swarm, humanity prevails.";
const LINE2 = "STARSPEED out.";
...
export function mountEarthOutroOverlayBlack() {
...
export async function runEarthOutroTypewriterAndFade(options = {}) {
  ...
  await new Promise((resolve) => {
    ...
    const fallback = setTimeout(finish, 2000 + 250);
    const onEnd = (e) => {
